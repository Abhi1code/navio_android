...
public class StepDetector {
    ...
    private static final float STEP_THRESHOLD = 200f;
    ...
    public void updateAccel(long timeNs, float x, float y, float z) {
        ...
        if(velocityEstimate > 10){
            Log.d("ABHI", "velocity estimate " + velocityEstimate);
            //PathConfig.getInstance().updateNewCoords();
